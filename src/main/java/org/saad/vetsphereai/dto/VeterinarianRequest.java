...
public class VeterinarianRequest {
    ...
    public VeterinarianRequest() {
    }

    public VeterinarianRequest(String fullName, String specialization, Integer experiance, String qualification, String phone, String email) {
